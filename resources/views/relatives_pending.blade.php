                                        ...
                                        <div class="front">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="bottom" id="approve-buttons-{{ $relation->id }}">
                                                    <div class="text-success approved" style="display: none"><i class="fa fa-check"></i> Aprovado com sucesso</div>
                                                    <div class="text-danger denied" style="display: none"><i class="fa fa-times"></i>Eliminar</div>
                                                    <a href="javascript:;" class="btn btn-success approve-button btn-sm" onclick="relativeRequest(1, {{ $relation->id }})"><i class="fa fa-check"></i> Aprovar</a>
                                                    <a href="javascript:;" class="btn btn-danger approve-button btn-sm" onclick="relativeRequest(2, {{ $relation->id }})"><i class="fa fa-times"></i> Desfazer</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

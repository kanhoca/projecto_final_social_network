...
<div class="panel panel-default new-post-box">
    <div class="panel-body">
        <form id="form-new-post" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="group_id" value="{{ $wall['new_post_group_id'] }}">
            <textarea name="content" placeholder="Partilhe momentos"></textarea>
            ...
            <div class="row">
                <div class="col-xs-4">
                    <button type="button" class="btn btn-default btn-add-image btn-sm" onclick="uploadPostImage()">
                        <i class="fa fa-image"></i> Add Imagem
                    </button>

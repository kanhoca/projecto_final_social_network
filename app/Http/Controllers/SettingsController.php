...
class SettingsController extends Controller
{
    ...
    public function update(Request $request){
        ...
        if ($save){
            $request->session()->flash('alert-success', 'Actualizado com sucesso!');
        }else{
            $request->session()->flash('alert-danger', ($additional_msg)?$additional_msg:'Erro ao salvar, reavalie as alterações!');
        }

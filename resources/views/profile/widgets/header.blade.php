                        ...
                        @if($my_profile)
                            ...
                            <form id="form-upload-profile-photo" enctype="multipart/form-data">
                                <div class="change-image">
                                    <a href="javascript:;" class="upload-button" onclick="uploadProfilePhoto()"><i class="fa fa-upload"></i>Actualizar Foto</a>
                    ...
                    @if($my_profile)
                        <form id="form-upload-cover" enctype="multipart/form-data">
                            <div class="profile-upload-cover">
                                <a href="javascript:;" class="btn btn-info upload-button" onclick="uploadCover()"><i class="fa fa-upload"></i>Alterar foto de capa</a>

                                        ...
                                        <div class="front">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="bottom" id="approve-buttons-{{ $relation->id }}">
                                                    <div class="text-success approved" style="display: none"><i class="fa fa-check"></i> Sucesso...</div>
                                                    <div class="text-danger denied" style="display: none"><i class="fa fa-times"></i> Eliminado</div>
                                                    <a href="javascript:;" class="btn btn-success approve-button btn-sm" onclick="followRequest(1, {{ $relation->id }})"><i class="fa fa-check"></i> Aprovar</a>
                                                    <a href="javascript:;" class="btn btn-danger approve-button btn-sm" onclick="followRequest(2, {{ $relation->id }})"><i class="fa fa-times"></i> Eliminar</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
